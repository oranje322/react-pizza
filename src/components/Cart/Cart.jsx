...
import {addPizzaToCart, clearCart, deleteOnePizza, deletePizzaItem} from "../../redux/reducers/cartReducer";
                            ...
                            <div className="content__items">
                                {
                                    addedPizzas.map((pizza, index) => {
                                        return (
                                            <CartItem key={index} data={pizza} howManyPizzasAdded={items[pizza.id].length}
                                                      onAddPizzaToCart={onAddPizzaToCart}
                                                      onDeletePizzaItem={onDeletePizzaItem}
                                                      onDeleteOnePizza={onDeleteOnePizza}/>
                                        )
                                    })
                                }
